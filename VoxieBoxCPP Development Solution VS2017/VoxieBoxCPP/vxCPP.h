...
public:
	...
	//! returns the internal voxie_wind_t's aspect R ratio ( for circular displays)

/*
	virtual float	getAspectR() = 0;
	//! returns the internal voxie_wind_t's aspect Rmin  ratio ( for circular displays)
	virtual float	getAspectRMin() = 0;
	*/
