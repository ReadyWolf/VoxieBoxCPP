...
// an input action holds all the info you'll need to decipher (or add your own...)
...
private:
	...
	std::vector<inputActionMsg_t>  inputPool; // input pool is public so its a bit easier to manage
